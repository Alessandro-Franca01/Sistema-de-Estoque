...
class EntradaController extends Controller
{
    public function listarEntrada(){
        ...
        ->select('entradas.id_entrada','produtos.path_image as imagens','produtos.codigo_produto','produtos.descricao', 'produtos.tamanho', 'produtos.valor', 'produtos.valor_compra','entradas.created_at','entradas.quantidade')
